...
library Permit2MultichainWitnessType {
    bytes constant MULTICHAIN_PERMIT2_WITNESS_TYPE_STUB =
        abi.encodePacked(
    ...
    bytes constant MULTICHAIN_PERMIT2_WITNESS_TYPE =
        abi.encodePacked(
    ...
    bytes32 constant MULTICHAIN_PERMIT2_WITNESS_TYPE_HASH =
        keccak256(MULTICHAIN_PERMIT2_WITNESS_TYPE);
