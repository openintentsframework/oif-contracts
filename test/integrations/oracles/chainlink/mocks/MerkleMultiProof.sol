...
library MerkleMultiProof {
    ...
    /// a hash operation.
    /// @dev the maximum number of hash operations it set to 256. Any input that would require more than 256 hashes to
    /// get
    ...
    // We mark this function as internal to force it to be inlined in contracts that use it, but semantically it is
    // public.
        ...
        unchecked {
            ...
            for (uint256 i = 0; i < totalHashes; ++i) {
                ...
                if (proofFlagBits & (1 << i) == (1 << i)) {
                    ...
                    if (leafPos < leavesLen) a = leaves[leafPos++];
                    else a = hashes[hashPos++];
                } else {
                ...
                bytes32 b;
                if (leafPos < leavesLen) b = leaves[leafPos++];
                else b = hashes[hashPos++];
