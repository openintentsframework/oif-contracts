...
contract InputSettlerMultichainEscrowTest is InputSettlerMultichainEscrowTestBase {
    ...
    function test_finalise_self_2_inputs() public {
        ...
        vm.prank(solver);
        outputSettlerSimple.fill(orderId, order.outputs[0], order.fillDeadline, abi.encode(solver));
    ...
    function test_openFor_permit2_finalise_self_2_inputs() public {
        // -- Set Up --//
        ...
        vm.prank(swapper);
        anotherToken.approve(permit2, type(uint256).max);
